...
import { disposeMode, syncRuntimeState } from '../../services/eegBridgeService.js?v=2026-07-28-2';
import { importGameRuntime } from '../../services/runtimeLoader.js?v=2026-07-28-2';
                ...
                <div id="ui-container" style="opacity: 0; transform: translateY(10px); filter: blur(6px);">
                    ...
                    <div id="focus-indicator">
                        <div id="mode-status-card">
                            ...
                            <div id="mode-status-detail">Real EEG or camera</div>
                        </div>
