...
| **🎤 答辯準備（07-17 起・老師新方向）** | 隊員用 **Canva 砌 8 頁 PPT**（照手冊 **6.3** 個 prompt 直接貼入去）＋cap 三張截圖（閱讀/測驗/Results）＋Slide 2 條片離線版；**Steven 拍板**：閱讀階段角落加唔加細船（手冊 Part 9 🔑）；講稿 A–E（手冊 **6.4**）計時行一次 ≤3.5 分鐘；錄一條完整學習流程**備用錄屏**；比賽朝早用 demo 帳戶**預先完成一場** study session、開定 Results tab |
