...
**References（底部細字，同 PPT S2 一致）**
- Gloria Mark 團隊（UC Irvine）：螢幕專注時長 47 秒／中斷後 23 分 15 秒（gloriamark.com；APA Speaking of Psychology）。
- Ra et al., *JAMA* 2018：高頻數碼媒體使用與青少年 ADHD 症狀（jamanetwork.com/journals/jama/fullarticle/2687861）。
- 香港青少年螢幕時間 2024/25 調查（The Standard HK／news.gov.hk 2025-04）。
- 技術：NeuroSky MindWave、MediaPipe（Google）、Three.js、Supabase、Vercel；提示音效：Universfield（Pixabay）。
