...
| **🎤 答辯準備（07-17 起・零現場操作版）** | 隊員用 **Canva 砌 9 頁 PPT**（手冊 **6.3** 有齊每頁文字＋prompt，直接 copy）；**拍 S6 對比影片**（專心 vs 分心，照手冊 **6.5** 拍攝清單，~40 秒）；cap 截圖（閱讀/測驗/Results/Setup）；S2 四個數據來源隊員再核實一次；講稿 A–E（手冊 **6.4**）連影片計時行一次 ≤3 分 50 秒；比賽日手提機開定真平台 standby 畀 Q&A |
